import { logger, startTimer } from '../utils/bked_logger.js';
    ...
    async collectDatabaseMetrics() {
        try {
            ...
            this.metrics.database = {
                ...
                errors: health.status === 'unhealthy' ? this.metrics.database.errors + 1 : this.metrics.database.errors
            };
            ...
            this.metrics.database = {
                status: 'unhealthy',
                responseTime: 0,
                services: { error: 'monitoring failed' },
