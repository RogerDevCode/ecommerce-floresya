 ...
 *     CarouselImage:
 *       type: object
 *       required: [id, url, alt, title, order]
 *       properties:
 *         id:
 *           type: string
 ...
 *           type: string
 *           format: uri
 *           description: URL de la imagen optimizada
 *         alt:
 *           type: string
 ...
 *         description:
 *           type: string
 *           description: Descripción opcional para caption
 *         order:
 *           type: integer
...
/**
 * Professional Carousel Service Class
 * Implements industry standards for carousel functionality
 */
export class CarouselService {
  ...
  private handleResize(): void {
    ...
    if (carouselInner) {
      carouselInner.style.height = `${this.config.height}px`;
    }
  }
